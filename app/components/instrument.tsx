...
export default function Instrument({ id, name, price, imageUrl, like, isNew, onDelete, onEdit }: InstrumentProps) {
  return (
    <div className="relative border p-4 rounded shadow-md flex flex-col items-center">
      {isNew && (
      ...
      <Link href={`/music/instrument/${id}`}>
        <div className="cursor-pointer">
          <img src={imageUrl} alt={name} className="w-32 h-32 object-cover mt-4" />
