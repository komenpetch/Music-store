...
export default function Home() {
  return (
    <div>
      ...
      <Link href="/server" className="text-3xl p-28 text-center text-black font-extrabold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">Server</Link>
    </div>
  );
}
